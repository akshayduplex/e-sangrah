...
//         data.is_show = data.is_show === "true"; // boolean
//         data.priority = Number(data.priority);  // ensure number

//         // ✅ Get values injected by EJS
...
//             const result = await response.json();
//             console.log("Form submission result"); // debug
//             if (result.success) {
